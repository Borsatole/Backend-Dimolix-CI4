...
{
    private AgendamentosModel $model;
    ...
    {
        $this->model = new AgendamentosModel();
    ...
    public function listar(array $params): array
    {
        ...
        foreach ($registro['registros'] as $key => $value) {

            // buscar nome cliente
            $registro['registros'][$key]['cliente'] = $this->clienteModel->buscarPorId($value['cliente_id']);

            // buscar endereco
            $registro['registros'][$key]['endereco'] = $this->enderecosModel->buscarPorId($value['endereco_id']);
    ...
    {
        $this->db->transStart();
        $this->validarCampoObrigatorio($dados, 'categoria_item');
